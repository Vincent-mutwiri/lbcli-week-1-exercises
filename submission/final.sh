...
# WRITE YOUR SOLUTION BELOW:
LEGACY_ADDR=mpmAnY17Rp3Kuj3wcvZMuBfKhZAJdktYN1
check_cmd "Legacy address generation"

P2SH_ADDR=2MtWssJSJrrLBomDDor6GhD2zNNaeRUgNj3

check_cmd "P2SH address generation"

SEGWIT_ADDR=bcrt1qjdk2k8sskas0rj65j2wm8que9ulcl6nc4m0qme

check_cmd "SegWit address generation"

TAPROOT_ADDR=bcrt1p6x2vyjvgr07mxn37emlj4r8xqyflpum4j0us086gpw6cfdjx7d5qe745sq
